...
public class AllPatientLogJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblPatient.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Patient ID", "Age", "Phone", "Residence", "Community", "City", "Blood pressure", "Temperature", "Pulse", "Respiration", "Visit Date"
            }
        ));
        jScrollPane1.setViewportView(tblPatient);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 1070, 140));

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 102, 102));
        jLabel1.setText("All Patient Visit Log");
